    ...
    <>
      <div className={styles.propertycontainer}>
        ...
        <Image
          ...
          height={486}
          alt="property-image"
          className={styles.imagecontainer && styles.propertyimage}
        />
        ...
        <div className={styles.heading}>
          <p className={styles.landmarks}>2Hospitals</p>
          <p className={styles.landmarks}>4 Gas Stations</p>
          <p className={styles.landmarks}>2 Schools</p>
        </div>
      </div>
      <NavBar />
    </>
